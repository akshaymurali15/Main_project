              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="enabledisable.php?a_id=<?php echo $row['Login_id'];?>&&ss=BLOCKED"><Button type="submit" class="btn btn-primary">ENABLE</Button></a>
                    <?php } else { ?>  
                    <a href="enabledisable.php?a_id=<?php echo $row['Login_id'];?>&&ss=ACCEPTED"><Button type="submit" class="btn btn-primary">DISABLE</Button></a>
                    <?php } ?>
